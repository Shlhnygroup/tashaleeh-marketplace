...
-- Master SQL V4.0 — تاريخ التحديث: إبريل 2026
-- تدمج:
--   ✅ التحديثات السابقة (الطلبات، التقييم، سجلات الأمان، الملف الشخصي)
--   ✅ ترقية V4.0: الرقابة الصارمة (إخفاء الطلبات) والمحاسبة المالية المستقلة والبنرات.
-- ============================================================
...
-- تحديث الجداول الحالية إذا كانت موجودة مسبقاً
ALTER TABLE public.requests ADD COLUMN IF NOT EXISTS is_hidden boolean DEFAULT false;
...
-- تحديث הגداول الحالية
ALTER TABLE public.responses ADD COLUMN IF NOT EXISTS is_hidden boolean DEFAULT false;
...
-- ============================================================
-- 2. إعدادات التطبيق، البنرات والماركات (ترقية V4.0 المدمجة)
-- ============================================================

CREATE TABLE IF NOT EXISTS public.app_settings (
  id integer PRIMARY KEY DEFAULT 1,
  whatsapp_number text NOT NULL DEFAULT '966500000000',
  app_policy text NOT NULL DEFAULT 'التطبيق يضمن القطعة ومطابقتها. الخدمة مجانية حالياً.',
  privacy_policy text DEFAULT 'تطبق هنا سياسة الخصوصية...',
  terms_conditions text DEFAULT 'الشروط والأحكام الخاصة بالتطبيق...',
  commission_rate numeric DEFAULT 0.0,
  subscription_fee numeric DEFAULT 0.0
);
-- تحديث الإعدادات لمن لديه جدول جاهز
...
-- ============================================================
-- 3. نظام البروفايلات والبائعين (المدمجة مع V4.0)
-- ============================================================
...
-- تحديث البائعين الموجودين مسبقاً
...
-- ============================================================
-- 4. جداول الرقابة والمالية (الجديدة V4.0)
-- ============================================================
...
-- ============================================================
-- 10. سياسات Requests (معدلة تدعم V4.0 و is_hidden)
-- ============================================================
...
-- ============================================================
-- 11. سياسات Responses (معدلة لتتضمن is_hidden)
-- ============================================================
...
-- ============================================================
-- 13. سياسات Banners و Transactions و Reports و Logs
-- ============================================================
...
-- ============================================================
-- 15. Cascade Deletion — الحذف النظيف
-- ============================================================
...
-- ============================================================
-- ✅ اكتمل تحديث وبناء التطبيق بنجاح (النسخة V4.0 الكاملة) !
-- ============================================================
SELECT 'Master SQL V4.0 applied successfully with full admin controls & financial tracking! ✅' AS status;
