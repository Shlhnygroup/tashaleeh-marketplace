...
const sql = `
  ...
  -- إلغاء RLS مؤقتاً لتسهيل التطوير
...
async function setupTables() {
  try {
    console.log("جارِ الاتصال بقاعدة البيانات لتحديث الجداول (V2)...");
    await client.connect();
    console.log("تم الاتصال بنجاح. يتم الآن تحديث/إنشاء الجداول...");
    
    await client.query(sql);
    console.log("🎉 تمت العملية بنجاح! قاعدة البيانات جاهزة الآن للنسخة المتطورة.");
  } catch (err) {
